...
Source: 
https://github.com/RobertTLange/gymnax/blob/aef77d5c642ea48b95f34c51d05b8417d9450e15/gymnax/environments/classic_control/mountain_car.py
Original Source:
...
import importlib
module = importlib.import_module('envs.MountainCar-v0.reward')
...
class MountainCar(environment.Environment[EnvState, EnvParams]):
    ...
    def step_env(
        ...
        # Update state dict and evaluate termisnation conditions
